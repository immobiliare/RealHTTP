...
extension HTTPRequestProtocol {
    ...
    private func addCredentials(for request: URLRequest, whenIn client: HTTPClientProtocol, into components: inout [String]) {
    ...
    ///   - client: where the request is running in.
    ///   - components: components array.
    private func addSetCookies(for request: URLRequest, whenIn client: HTTPClientProtocol, into components: inout [String]) {
    ...
    ///   - client: where the request is running in.
    ///   - components: components array.
    private func addHeaders(for request: URLRequest, whenIn client: HTTPClientProtocol, into components: inout [String]) {
        let configuration = client.session.configuration
    ...
    ///   - client: where the request is running in.
    ///   - components: components array.
    private func addBody(for request: URLRequest, whenIn client: HTTPClientProtocol, into components: inout [String]) {
